...
DataType    = 'MRscan';         % Type of the dataset. Choose from 'PET', 'CT' or 'MRscan'
...
Feats2out   = 5;            % Select carefully! (default 2) which set of features to return: 1: all IBSI features, 2: 1st-order+all 3D features, 3: 1st-order+only 2D features, 4: 1st-order + selected 2D + all 3D features, 5: all features + moment invarient, 6: Custom set of feature classes should be defined in "ReturnFeatures.m"
